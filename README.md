...
This repository is the single source of truth for the **Subscription Management Micro-SaaS** platform. It contains all the technical documentation required for AI agents to design, build, deploy, operate, and evolve the application across **Web, iOS, and Android**. It is also structured to be understandable by human stakeholders who oversee the project and by marketing teams who need to understand the product's value proposition.

## 2. The Product in a Nutshell

**Subscription Management** is an intelligent, mobile-first platform that helps individuals, families, and small teams take complete control of their recurring subscription payments.
...
**Our Solution:** A dedicated "control cockpit" available on your phone and computer that provides complete visibility, proactive intelligence (like automated trial detection from email and instant import from bank statements), and effortless control over all recurring expenses.
...
| :--- | :--- |
| **Mobile-First** | The native iOS and Android apps are the primary user experience. The web app is a secondary, but important, interface. |
...
| **Globally Accessible** | The platform launches in English and Spanish, with an architecture supporting rapid, AI-assisted translation into future languages. |
...
| Document | Description |
| :--- | :--- |
| [Mobile App Development Guide](MOBILE_APP_DEVELOPMENT_GUIDE.md) | **NEW:** How to build the native iOS and Android apps using React Native and Expo. |
| [Statement Upload & Wallet Integration Guide](STATEMENT_UPLOAD_AND_WALLET_INTEGRATION_GUIDE.md) | How to implement bank statement parsing and OAuth-based wallet connections. |
...
| [Frontend Development Guide](FRONTEND_DEVELOPMENT_GUIDE.md) | How to build the web UI using Refine and the Metronic theme. |
...
| Layer | Technology |
| :--- | :--- |
| **Mobile Apps (Primary)** | **React Native, Expo SDK 49, TypeScript** |
| **Web App (Secondary)** | React 18, Vite, Tailwind CSS 3.x, Metronic Theme, i18next |
...
5.  **Build Mobile:** Follow the [Mobile App Development Guide](MOBILE_APP_DEVELOPMENT_GUIDE.md) for iOS/Android work.
6.  **Build Web:** Follow the [Frontend Development Guide](FRONTEND_DEVELOPMENT_GUIDE.md) for web work.
